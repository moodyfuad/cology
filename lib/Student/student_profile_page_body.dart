            ...
            children: [
              Expanded(
                child: Padding(
                  ...
                  child: TextFormField(
                    initialValue: CerntStudent.student[0].idRegstrion,
            ...
            children: [
              ...
              Expanded(
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: TextFormField(
                    initialValue: "الترم ${CerntStudent.student[0].smster}",
                    decoration: const InputDecoration(
                      labelText: "الترم",
                    ),
                    readOnly: true,
            ...
            children: [
              Expanded(
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: TextFormField(
                    initialValue: CerntStudent.student[0].passWord,
                    decoration: const InputDecoration(
            ...
            child: ElevatedButton(
              onPressed: () {
                for (var item in showallMessages.show) {
                  var keysToRemove =
                      item.chats.keys.where((key) => key != 1).toList();
                ...
                var stu = Student.student.firstWhere(
                  (item) =>
                      item.idRegstrion == CerntStudent.student[0].idRegstrion,
                );
              ...
              style: CustomButton.primaryButtonStyle(screenWidth).copyWith(
